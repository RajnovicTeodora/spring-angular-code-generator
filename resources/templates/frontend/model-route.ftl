...
import { ${class.name}EditComponent } from './${class.name}-edit/${class.name}-edit.component';
import { ${class.name}ViewComponent } from './${class.name}-view/${class.name}-view.component';
