...
public class ApplicationProperties extends BasicGenerator {
	private final String PACKAGE_NAME = "resources";

	public ApplicationProperties(GeneratorOptions generatorOptions) {
